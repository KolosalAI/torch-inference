...
impl Monitor {
    ...
    pub fn record_request_end(&self, latency_ms: u64, endpoint: &str, success: bool) {
        ...
        // fetch_min / fetch_max are atomic and correct under concurrent access
        // (stable since Rust 1.45), replacing the previous hand-rolled CAS loops.
...
mod tests {
    ...
    fn test_monitor_cas_min_latency_barrier_contention() {
        ...
        assert!(
            (metrics.min_latency_ms - 1.0).abs() < 0.001,
            "min_latency should be 1.0, got {}",
